...
/**
 * This User has all permission such as Add book Remove book add user Take a
 * book Give back book for all users
 *
 */
@SuppressWarnings("unchecked")
public class Administrator extends PersonLinkedList {
    ...
    /**
     * This is override from PersonArrayList abstract class This print all books
     * which is taken by user and print user inform who take that
     *
     */
    @Override
    public void printBooksAtUser() {
        ...
        System.out.println("id-Book Name- User Name");
         LinkedList <Book>  temparr = getBooklist();
        boolean flag = false;
    ...
    public void printMenu() {
        try {
            PersonLinkedList.updateBookData();
            double endTime, begtime;
            double result;
            boolean exit = false;
            while (!exit) {
                ...
                switch (input) {
                    case 1:
                        ...
                        result = (endTime - begtime) / 1000;
                        
                        System.out.println("printBooksinLib çalışma zamanı=" + result);
                        ...
                        if (input2 != -1) {
                            ...
                            System.out.println("searchBook çalışma zamanı=" + result);
                            ...
                            if (inform == null) {
                                ...
                                endTime = System.nanoTime();
                                result = (endTime - begtime) / 1000;
                                System.out.println("lendBook çalışma zamanı=" + result);
                    ...
                    case 2:
                        ...
                        if (input2 != -1) {
                            ...
                            endTime = System.nanoTime();
                            result = (endTime - begtime) / 1000;
                            System.out.println("GiveBackBook çalışma zamanı=" + result);
                        }
                        break;
                    case 3:
                        ...
                        endTime = System.nanoTime();
                        result = (endTime - begtime) / 1000;
                        System.out.println("addbook çalışma zamanı=" + result);
                        break;
                    case 4:
                        begtime = System.nanoTime();
                        printBooksinLib();
                        ...
                        endTime = System.nanoTime();
                        result = (endTime - begtime) / 1000;
                        System.out.println("printBooksAtUser çalışma zamanı=" + result);
                        System.out.println("Please select bookid:");
                        System.out.println("-1 for exit;");
                        input2 = tara.nextInt();
                        if (input2 != -1) {
                            ...
                            if (inform == null) {
                                ...
                                endTime = System.nanoTime();
                                result = (endTime - begtime) / 1000;
                                System.out.println("removebook çalışma zamanı=" + result);
                    ...
                    case 5:
                        ...
                        endTime = System.nanoTime();
                        result = (endTime - begtime) / 1000;
                        System.out.println("adduser çalışma zamanı=" + result);
                        break;
                    case 6:
                        exit = true;
                    default:
