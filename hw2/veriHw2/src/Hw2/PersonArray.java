...
public abstract class PersonArray implements IPerson {
    /**
     ...
     */
    protected static GenericArray<Book> booklist = new GenericArray<>();
    /**
     * This save the all user information in list
     */
    protected static GenericArray<IPerson> userlist = new GenericArray<>();
    /**
     * 
     * @return User id
     */
    ...
    public void printBooksinLib() {
        ...
        GenericArray<Book> temparr = getBooklist();
        boolean flag = false;
     ...
     * @return Book list
     */
    public GenericArray<Book> getBooklist() {
        return booklist;
    }
    /**
     * 
     * @return User list
     */
    public GenericArray<IPerson> getUserlist() {
        return userlist;
    }
    /**
     * 
